...
| [wave2_coverage_breadth.md](wave2_coverage_breadth.md) | Active | Improve analyst/claim coverage breadth on rich enumeration-heavy bundles before more export or model changes. |
