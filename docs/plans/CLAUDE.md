...
| [tyler_literal_parity_refactor.md](tyler_literal_parity_refactor.md) | In Progress | Major contract migration to make Tyler's V1 schemas and prompts literal repo-local runtime surfaces rather than adapted references. Runtime Stage 1-6 migration is done; the remaining open work is Tyler-native quality recovery and explicit shared-infra boundary recording. |
