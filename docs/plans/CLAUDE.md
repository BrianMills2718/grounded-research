...
| [wave2_coverage_breadth.md](wave2_coverage_breadth.md) | In progress | Improve analyst/claim coverage breadth on rich enumeration-heavy bundles before more export or model changes. |
| [wave2_report_synthesis_calibration.md](wave2_report_synthesis_calibration.md) | Active | Calibrate long-report/structured synthesis after coverage breadth improved but the UBI fair comparison still lost. |
| [docs_authority_reconciliation.md](docs_authority_reconciliation.md) | Planned | Bring CLAUDE, PLAN, ROADMAP, and the plan index back into one coherent authority chain. |
