...
| [wave2_enumeration_grounding.md](wave2_enumeration_grounding.md) | Planned | Benchmark-driven follow-up for study/PDF retrieval, Claimify evidence anchoring, and dense-claim dedup on enumeration-heavy questions. |
