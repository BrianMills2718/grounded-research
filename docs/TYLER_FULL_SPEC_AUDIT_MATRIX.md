...
| BP-S2-001 | `1. V1_Build_Plan_Step_By_Step.md` | `## Stage 2 — Broad Retrieval & Evidence Normalization` | `stage_rule` | Stage 2 retrieval, routing, scoring, normalization | static + runtime | audited_gap_recorded | `S2-QUERY-MODEL-001`, `S2-ROUTING-001`, `S2-QUALITY-001`, `S2-TAVILY-DEPTH-001`, `S2-EXA-CONTROLS-001` | Exhaustive audit reopened Stage 2 query generation: Tyler packet says orchestrator string templates, but live runtime still uses an LLM call |
