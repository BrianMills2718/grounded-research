...
| PR-S2-QUERYTEMPLATE-001 | `4. V1_PROMPTS.md` | `## Stage 2 — Query Variant Generation (Orchestrator Template)` | `orchestrator_template` | Stage 2 query variant template | static + runtime | audited_gap_recorded | `S2-QUERY-MODEL-001` | Prompt packet explicitly says this is orchestrator string expansion, but the live runtime still uses an LLM call |
