    ...
    return QuestionDecomposition(
        ...
        sub_questions=[
            CurrentSubQuestion(
                ...
                type="factual",
                falsification_target="Contradictory pilot evidence",
            ),
            CurrentSubQuestion(
                id="SQ-2",
                text="How should we interpret mixed findings?",
                type="evaluative",
                falsification_target="A stronger interpretation",
            ),
        ],
        optimization_axes=["employment vs broader welfare"],
...
def test_current_bundle_to_tyler_evidence_package_translates_legacy_current_ids() -> None:
    bundle = EvidenceBundle(
        question=ResearchQuestion(text="What is the current evidence?"),
        sources=[
            SourceRecord(
        ...
        evidence=[
            ...
            EvidenceItem(
                id="E-2",
                source_id="S-2",
                content="Pilot B found no measurable employment effect.",
                content_type="quotation",
                sub_question_ids=["SQ-1"],
            ),
        ],
    ...
    package = current_bundle_to_tyler_evidence_package(
        bundle,
